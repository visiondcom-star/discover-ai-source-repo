    ...
    for row in reader:
        try:
            ...
            poi = POI(
                ...
                city=row.get("city", ""),
                categories=[c.strip() for c in (row.get("categories") or row.get("category", "culture")).split(",") if c.strip()],
    ...
    for item in pois_data:
        try:
            ...
            poi = POI(
                ...
                city=item.get("city", ""),
                categories=item.get("categories") or [item.get("category", "culture")],
